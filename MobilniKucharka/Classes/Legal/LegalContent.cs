namespace MobilniKucharka.Classes.Legal
{
    public static class LegalContent
    {
        ...
        [
            ...
            new() { Heading = "GitHub", Body = "Update checks, temporary recipe link-sharing, and in-app bug reports use the public GitHub API and GitHub repositories (github.com), operated by GitHub, Inc." },
